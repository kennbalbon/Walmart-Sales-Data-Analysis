...
CREATE OR REPLACE VIEW vw_store_performance_top_rankings AS
...
;
-- Bottom 5
CREATE OR REPLACE VIEW vw_store_performance_bottom_rankings AS
WITH store_averages AS 
(
-- Calculate the average for all stores. 
SELECT
...
-- Holiday Impact 
CREATE OR REPLACE VIEW vw_holiday_lift_metrics AS
SELECT
...
CREATE OR REPLACE VIEW vw_macro_unemployment AS
...
CREATE OR REPLACE VIEW vw_macro_cpi AS
SELECT
	CASE 
...
CREATE OR REPLACE VIEW vw_macro_fuel_prices AS
